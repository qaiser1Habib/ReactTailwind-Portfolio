				...
				<div className="grid md:grid-cols-2 gap-12 items-center">
					<div className="space-y-6">
						...
						<p className="text-gray-600 leading-relaxed">
							...
							of hands-on experience in the MERN stack. My expertise lies in creating responsive, user friendly web
							applications with a strong focus on frontend development.
						</p>
						<p className="text-gray-600 leading-relaxed">
							I specialize in building robust Backend services and APIs while ensuring exceptional user experiences through
							modern frontend technologies. My goal is to write clean, efficient code that delivers both performance and
							scalability.
						</p>
